...
export async function importPackage(buffer,storage){
 ...
 if(manifest.format!=='sm3dl'||!['0.1.0','0.2.0'].includes(manifest.version)||!Array.isArray(manifest.views)||manifest.views.length>200||!manifest.views.length||!Array.isArray(manifest.files)||manifest.files.length>2000)throw Error('Unsupported SM3DL package.');
